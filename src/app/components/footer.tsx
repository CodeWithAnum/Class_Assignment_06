...
function Footer () {
    return (
            ...
            <div>
                <div>
                <h2 className="font-black text-[18px] font-semibold mb-2 leading-6 font-roboto text-center ml-[-44px] lg:ml-[44px] lg:pr-[1014px]">Subscribe to our newsletter</h2>
          ...
          <input
            ...
            id="footer-field"
            className="lg:w-[265px] w-[275px] ml-[-22px] h-[48px] bg-white bg-white rounded border border-black lg:ml-[944px] lg:mt-[44px] lg:ml-[44px]"/>
            <Button variant="outline" className="lg:w-[119px] w-[275px] ml-[-22px] lg:ml-[6px] h-[48px] inline-flex lg:mt-[44px] border-black">Subscribe</Button>
      ...
      <div className="container mx-auto px-4 mt-8 lg:mt-[74px] grid grid-cols-1 md:grids-cols-3 gap-2 mr-[644px] mt-[-44px] lg:ml-[144px]">
      ...
      <div className="ml-[164px] lg:mt-[-244px] lg:ml-[444px]">
  ...
  <div className="mt-8 text-center text-sm text-black pt-4 mt-[484px]">
    <div className="lg:mt-[124px] lg:ml-[-2144px] border-t border-black pt-[12px]">
      <div className="pl-[4px]">
        <div className="ml-[224px]">
          <label
            ...
            className="leading-7 pl-[44px] ml-[-264px] lg:ml-[-884px] lg:text-sm text-[14px] text-black pr-[1299px]"
          >
        ...
        <div className="relative sm:w-64 w-[342px] h-[21px] lg:gap-[24px] mt-2 pr-[248px]">
        <label
            htmlFor="footer-field"
          ...
          <label
            htmlFor="footer-field"
            className="leading-7 text-sm text-black underline underline-offset-8 ml-[-42px]"
          >
             Terms of Service
          </label>
          </div>
          ...
          <label
            htmlFor="footer-field"
            className="leading-7 text-sm text-black underline underline-offset-8 lg:ml-[224px] ml-[204px]"
          >
             CookiesSettings
          </label>
          </div>
      ...
      <span className="lg:inline-flex flex lg:ml-[864px] pr-[884px] lg:mt-[-214px] lg:ml-[894px] lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto pt-[42px] ml-[-144px]">
