    ...
    return (
             <div className="hero mx-auto w-full max-w-[1280px] px-4 py-8 flex flex-col-reverse lg:flex-row items-center lg:justify-between"> 
               ...
               <div className="flex flex-wrap lg:flex-nowrap gap-4 mt-6">
                <Button variant="outline" className="w-[168px] h-[48px] bg-black text-white">Start learning now</Button>

                <Button variant="outline" className="border-black w-[168px] h-[48px]">Explore Courses</Button>
