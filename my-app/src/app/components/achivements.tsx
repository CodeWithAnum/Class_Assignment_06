...
function Achivement () {
  ...
  <div className="flex flex-wrap sm:flex-col text-center mt-[44px]">
    <div className="p-4 w-full ml-[-114px] lg:ml-[-444px]">
      ...
      <div className="p-4 sm:w-full ml-[16px] lg:ml-[124px] lg:mt-[-88px]">
        <h2 className="title-font font-bold text-4xl sm:text-2xl text-black">
          370K
        </h2>
        <p className="leading-relaxed font-normal">Students</p>
      </div>
      <div className="p-4 sm:w-full ml-[64px] lg:ml-[424px] lg:mt-[-92px]">
        <h2 className="title-font font-bold text-4xl sm:text-2xl text-black">
          100+
        </h2>
