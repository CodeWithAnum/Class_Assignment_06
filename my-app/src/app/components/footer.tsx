...
function Footer () {
    return (
          ...
          <input
            ...
            <Button variant="outline" className="lg:w-[119px] w-[275px] h-[48px] inline-flex lg:mt-[44px] border-black">Subscribe</Button>
  ...
  <div className="mt-8 text-center text-sm text-black pt-4 mt-[484px]">
    <div className="lg:mt-[124px] lg:ml-[-2144px] border-t border-black pt-[12px]">
      ...
      <span className="lg:inline-flex flex lg:ml-[864px] pr-[884px] lg:mt-[-214px] lg:ml-[744px] lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto pt-[42px] ml-[-144px]">
